...
export class AuthUserBuilder {
    ...
    public setPasswordHash(hash: string): this { this.passwordHash = hash; return this; }
    public setName(name: string): this { this.name = name; return this; }
    public setState(state: (typeof AUTH_USER_STATE)[keyof typeof AUTH_USER_STATE]): this { this.state = state; return this; }
    ...
    public build(): AuthUser {
        return new AuthUser(this.id, this.email, this.passwordHash, this.name, this.state, this.agreementId, this.createdAt, this.updatedAt, this.deletedAt);
    }
}
...
export class AuthUser {
    ...
    public constructor(
        ...
        agreementId: string, createdAt: Date, updatedAt: Date, deletedAt?: Date,
    ) {
    ...
    public static get Builder(): AuthUserBuilder { return new AuthUserBuilder(); }
}
